...
$this->add_control(
    ...
    [
        ...
        'description' => __('Toggle to display or hide post images.', 'vasutheme'),
        'default' => 'yes',
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'type'    => \Elementor\Controls_Manager::SWITCHER,
        'description' => __('Toggle to display or hide post meta information.', 'vasutheme'),
        'default' => 'yes',
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'type'    => \Elementor\Controls_Manager::SWITCHER,
        'description' => __('Toggle to display or hide post titles.', 'vasutheme'),
        'default' => 'yes',
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'type'    => \Elementor\Controls_Manager::SWITCHER,
        'description' => __('Toggle to display or hide author images.', 'vasutheme'),
        'default' => 'yes',
    ]
);
